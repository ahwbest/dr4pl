...
Using "absolute" does not seem to change our plot while using "Tukey" generates a fit that is less weighted by the largest dosage level which produces an outlier response of zero.
...
The parameter *trend* helps force the fit to either "increasing" or "decreasing" in the event that you are confident that your response follows that trend. 
